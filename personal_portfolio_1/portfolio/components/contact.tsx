  ...
  const contactMethods = [
    {
      icon: Mail,
      label: "Email",
      value: "basabrajbiswas04122001@gmail.com",
    ...
    },
    {
      icon: Mail,
      label: "Outlook",
      value: "basabrajbiswas@hotmail.com",
      href: "mailto:basabrajbiswas@hotmail.com",
    ...
    },
    {
      ...
      value: "Chat on Teams",
      href: "https://teams.microsoft.com/l/chat/0/0?users=basabrajbiswas@hotmail.com",
      ...
      <div className="max-w-4xl mx-auto text-center">
        ...
        >
          ...
          <p className="text-lg text-muted-foreground max-w-2xl mx-auto">
            Open to Data Science, ML, and AI roles — internships, research collaborations,
              ...
              <motion.div key={method.label} variants={itemVariants}>
                ...
                >
                  ...
                  <a
                    ...
                    className="text-primary hover:underline text-sm flex items-center justify-center gap-1 focus:outline-none focus:ring-2 focus:ring-primary focus:rounded break-all"
